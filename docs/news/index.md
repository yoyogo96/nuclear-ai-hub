...
#### 🇺🇸 미 하원 에너지·수자원 법안, 원자력·AI 지원 확대 — 재생에너지 축소
미국 하원 에너지·수자원 세출 법안이 원자력과 AI 인프라에 대한 지원을 대폭 확대하는 반면, 재생에너지 예산을 축소했다. 원자력이 AI 시대 기반 전력으로서 의회의 초당적 지지를 확고히 하는 신호.
- 출처: [E&E News by POLITICO](https://www.eenews.net/)

#### 🏗️ AtkinsRéalis, 원자력 기반 AI 데이터센터 팩토리 베팅 — 데이터센터 급증 대응
캐나다 AtkinsRéalis가 원자력으로 구동되는 AI 팩토리 구축에 베팅하고 있다. 글로벌 데이터센터 수요 급증에 대응해 원자력을 핵심 전력원으로 삼는 전략으로, SMR 및 대형 원전과 데이터센터의 직접 연계 모델을 추진 중.
- 출처: [Coast Reporter](https://www.coastreporter.net/)

### 원자력 AI 뉴스

#### 🤖 IAEA, 사이버 위협·AI·원자력 컨퍼런스 개최 — 원전 사이버보안에 AI 대응 논의
IAEA가 컴퓨터 보안 컨퍼런스를 개최해 원자력 시설의 사이버 위협과 AI의 역할을 논의했다. AI 기반 위협 탐지와 원전 운영 보호를 위한 국제 협력 방안이 주요 의제로 다뤄졌다.
- 출처: [IAEA](https://www.iaea.org/newscenter/news/cyber-threats-ai-and-nuclear-iaea-hosts-conference-on-computer-security)

#### 🤖 AI가 핵융합 실현을 앞당기고 있다 — AIP.org 심층 보도
미국물리학회(AIP)가 AI가 핵융합 상용화를 가속화하는 방식을 심층 보도했다. 플라즈마 제어 최적화, 설계 탐색 자동화, 실시간 이상 탐지 등 AI 응용이 융합 연구의 핵심 도구로 자리잡고 있으며, 상용화 타임라인 단축에 기여하고 있다.
- 출처: [AIP.org](https://www.aip.org/)

#### 🤖 "원전 vs AI 데이터센터" 여론조사 — 미국인 70% "데이터센터 반대, 원전은 OK"
최신 여론조사에서 미국인 70%가 자신의 동네에 AI 데이터센터 건설을 반대하는 반면, 원자력발전소는 선호하는 것으로 나타났다. Tom's Hardware 보도로, AI 인프라 확장의 사회적 수용성 한계와 원자력의 재평가가 동시에 드러나는 결과.
- 출처: [Tom's Hardware](https://www.tomshardware.com/)
...
#### 🇰🇷 뉴스케일파워 "한국 정부와 대미 투자 논의" — K-SMR 글로벌 시장 대진격, 인허가 병행 추진
미국 SMR 기업 뉴스케일파워가 한국 정부와 대미 투자 논의를 진행 중이다. 국내에서는 K-SMR 인허가 병행 절차가 추진되며 글로벌 시장 진격이 본격화하고, 글로벌 SMR 개발사들과의 협력 및 지분 투자를 통해 시공 데이터를 축적하는 전략이다.
- 출처: [조선비즈](https://n.news.naver.com/mnews/article/366/0001164107) / [대한경제](https://www.dnews.co.kr/uhtml/view.jsp?idxno=202605131130268870561)

#### 🇻🇳 베트남, 닌투언 1호 원전 프로젝트 속도 — EVN "낙찰자 선정 절차 완료" + 🇵🇱 폴란드 원전 K-원전 유럽 표준 선점 도전
베트남이 닌투얜 1호 원전 프로젝트의 낙찰자 선정 절차를 완료하며 사업이 본격화한다. 폴란드 원전 사업에서도 K-원전이 유럽 표준 선점을 위한 마지막 퍼즐로 주목받고 있어, 한국 원전의 동남아·유럽 동시 진출이 기대된다.
- 출처: [파이낸셜뉴스](https://n.news.naver.com/mnews/article/014/0005521081) / [글로벌이코노믹](https://www.g-enews.com/article/Global-Biz/2026/05/202605140555098168fbbec65dfb_1)

### 원자력 AI 뉴스

#### 🤖 "AI 전력수요 대응하려면 신규원전 50GW 필요" — 정용훈 KAIST 교수, 산업계 PPA 35GW 'Bridge-to-Build' 전략 제안
정용훈 KAIST 교수가 2026 한국원자력학회 춘계학술발표회에서 "2050년까지 신규 원전 50GW가 필요하며, 이 중 35GW를 산업계 장기 PPA로 활용하고 15GW는 한전 의무 인수"하는 모델을 제안했다. 기존 원전 활용으로 신규 원전 준공 전 8년 과도기를 메우는 'Bridge-to-Build' 전략으로, 연간 20.85조원 산업계 비용 절감 효과를 분석했다.
- 출처: [인사이트N파워](https://www.inpnews.kr/news/articleView.html?idxno=6981)

#### 🤖 Forbes: 원전, 지역사회에서 AI 데이터센터보다 훨씬 인기 — 원자력이 AI 인프라 '숨은 승자'
Forbes 보도에 따르면, 미국 지역사회 주민 여론조사에서 원자력발전소가 AI 데이터센터보다 압도적으로 높은 지지를 받고 있다. 원전은 고용·세수 혜택이 크고 환경 영향이 상대적으로 적어, AI 시대 전력 인프라로서 원자력의 사회적 수용성이 높은 것으로 나타났다.
- 출처: [Forbes](https://www.forbes.com/sites/rriley/2026/05/13/nuclear-power-plants-far-more-popular-than-ai-data-centers-for-local-areas/)
